...
public class BankBuilder {
   ...
   *
   * @param depositPercentage a list of DepositMoneyGapPercentage objects representing deposit
   *                          percentage gaps
   */
  ...
  /**
   * Returns the Bank object, assigns it to its account, resets itself, and returns the Bank
   * object.
   *
