...
/**
 * Class for the credit account It extends the Account class and includes methods for managing money
...
public class CreditAccount extends Account {
   ...
   */
  public CreditAccount(BigDecimal money, LocalDate openDate, LocalDate closeDate, User user,
      Bank bank, BigDecimal creditLimit, BigDecimal commission) {
  ...
  /**
   * Calculates daily percentage based on the number of days. CreditAccount doesn't have a
   * percentage
   *
  ...
  public void TakeOffMoney(BigDecimal money) {
      if (getMoney().compareTo(CreditLimit) < 0) {
