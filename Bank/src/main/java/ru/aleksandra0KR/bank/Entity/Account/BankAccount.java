...
/**
 * Class for the bank account It extends the Account class and includes methods for managing money
...
public class BankAccount extends Account {
   ...
   * @param openDate the date when the account was opened other parameters is nulls because the bank
   *                 account does not have an expiration date, a specific user, and commissions as a
   *                 percentage
   */
