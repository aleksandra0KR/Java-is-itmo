...
/**
 * Class for the deposit account It extends the Account class and includes methods for managing
...
public class DepositAccount extends Account {
   ...
   */
  public DepositAccount(BigDecimal money, LocalDate openDate, LocalDate closeDate, User user,
  ...
  public void TakeOffMoney(BigDecimal money) {
    CentralBank centralBank = CentralBank.getInstance();
      if (this.getCloseDate().isBefore(centralBank.getBankCalendar())) {
          throw new DepositErrorTakeOffMoney();
      }
