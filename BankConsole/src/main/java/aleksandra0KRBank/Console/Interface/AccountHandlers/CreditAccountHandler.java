...
/**
 * Class for handling creation of credit account requests
...
public class CreditAccountHandler extends AccountHandler {
    /**
     * Handles a request for a credit account creation.
     * If the request is for a credit account, it creates the account and prints its ID.
