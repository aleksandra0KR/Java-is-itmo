...
/**
 * Class for handling performance of withdraw transaction requests Extends TransactionHandler
 * class.
 *
...
public class WithdrawHandler extends TransactionHandler {
  ...
  /**
   * Handles a request for a withdraw transaction. If the request is for a withdraw transaction, it
   * prompts for bank and account details, processes the withdrawal, and prints the operation's ID.
