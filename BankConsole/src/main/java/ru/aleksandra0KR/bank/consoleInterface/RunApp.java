...
@CommandLine.Command(name = "myapp", subcommands = {StopCommand.class, HelpCommand.class,
    ...
    ShowHistoryOfTransactionsCommand.class, NotifyUsersCommand.class,
    ShowNotificationsCommand.class,
    SubscribeAccountOnNotificationsCommand.class, UnSubscribeAccountFromNotificationsCommand.class,
    ChangeCreditCommissionCommand.class, ChangeCreditLimitCommand.class,
    ChangeDebitPercentageCommand.class,
...
public class RunApp {
  ...
  static {
    ...
    COMMANDS.put("-unSubscribeAccountFromNotifications",
        new UnSubscribeAccountFromNotificationsCommand());
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      COMMANDS.getOrDefault(input, () -> System.out.println(
          "Invalid command. Please try again. Or Enter -help for list of commands")).run();
    }
  }
}
