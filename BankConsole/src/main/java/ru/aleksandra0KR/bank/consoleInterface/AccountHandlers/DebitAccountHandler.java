...
/**
 * Class for handling creation of debit account requests Extends AccountHandler class.
 *
...
public class DebitAccountHandler extends AccountHandler {
  ...
  /**
   * Handles a request for a debit account creation. If the request is for a debit account, it
