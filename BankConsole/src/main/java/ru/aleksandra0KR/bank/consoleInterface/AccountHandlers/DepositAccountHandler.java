...
/**
 * Class for handling creation of deposit account requests Extends AccountHandler class.
 *
...
public class DepositAccountHandler extends AccountHandler {
  ...
  /**
   * Handles a request for a deposit account creation. If the request is for a deposit account, it
   * creates the account and prints its ID. If not, it prints error.
   *
