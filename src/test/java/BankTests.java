...
public class BankTests {
    ...
    public void OpenDepositAccountMakeReplenishment() {
        ...
        addMoney.execute();
        assertEquals(BigDecimal.valueOf(150000), debitAccount.Money);
    }
    ...
    public void MakeTransfer() {
        ...
        transaction.execute();
        assertEquals(BigDecimal.valueOf(990000), creditAccount.Money);
    }
    ...
    public void Notifications() {
        ...
        assertEquals(user.get_messages().get(0),"Hello World!!!!!");
    }
